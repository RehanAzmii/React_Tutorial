          ...
          <ul class="list-unstyled float-right mb-0">
            ...
            <li class="dropdown notification-list">
              <a
                ...
                <span class="badge badge-danger noti-icon-badge">5</span></a
              >
              <div
              ...
              >
                ...
                <a
                  ...
                  <p class="notify-details">
                    <b>Thomas J. Mimms</b
                    ><small class="text-muted"
                      >You have 87 unread messages</small
                    >
                  </p></a>
                {/* ><!-- item--> */}
                <a
                  ...
                  <p class="notify-details">
                    <b>Luis M. Konrad</b
                    ><small class="text-muted"
                      >It is a long established fact that a reader will</small
                    >
                  </p></a>
                {/* ><!-- All--> */}
                <a
            ...
            <li class="dropdown notification-list">
              <a
                ...
                <span class="badge badge-success noti-icon-badge">2</span></a
              >
              <div
                class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg border-0"
              >
